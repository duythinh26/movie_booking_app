import { ChartLineIcon, CurrencyIcon, PlayCircleIcon, StarIcon, UserIcon } from 'lucide-react';
            ...
            <div className="relative flex flex-wrap gap-6 mt-4 max-w-5xl">
                <BlurCircle top='100px' left='-10%'/>
                {
                    dashboardData.activeShows.map((show, index) => (
                        ...
                        >
                            <img src={imageBaseUrl + show.movie.poster_path} alt="poster" className="h-full w-full object-cover" />
